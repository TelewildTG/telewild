...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {135693512,97528983},--Sudo users
    disabled_channels = {},
...
------------------------------------------
 بارکد :
 ساخت بارکد جلوی بارکد آدرس جایی که میخواهید را بزندید
------------------------------------------
 بگو :
 برای تکرار کردن متن جلوی بگو متن را بزنید
------------------------------------------
ارسال به ادمین  :
برای فرستادن نظراتتان به ما جلوش متنو بزنید
------------------------------------------
Telewild Bot
]],
    help_text = [[
